...
class MaskGenerator(nn.Module):
    def __init__(self, input_dim=1, output_dim=3, input_size=256, layers=[2, 2, 2]):
        ...
        self.deconv1 = self._make_block(256, 128, layers[0])
        self.deconv2 = self._make_block(128 + 128, 64, layers[1])
        self.deconv3= self._make_block(64 + 64, 32, layers[2])
